	...
	return (
		...
		>
			...
			>
				{/* Mode Switcher */}
				<div
					className={`p-0.5 rounded-xl flex gap-0.5 border ${
						darkMode
				...
				<div className="flex items-center gap-2 ml-auto">
					<button
						...
						className={`px-2.5 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all flex items-center gap-1.5 border shadow-sm cursor-pointer ${
							isCalendarOpen
